...
/**
 * Discover generated route-handler directories below the app `app` tree.
 *
...
const discoverGeneratedHandlerDirs = async appRootDir => {
  const appDir = path.join(appRootDir, 'app');
 ...
 * - every generated route-handler page folder below `app`
 *
