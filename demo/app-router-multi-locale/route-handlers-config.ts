 ...
 *
 * The app-router demo keeps two authoring-style variants, and both center on
 ...
 * build-only App Router path can still resolve the inactive variant correctly
 * when this stable selector module is imported outside the main page graph.
 */
