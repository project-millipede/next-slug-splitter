/**
 * Locale-aware catch-all docs route —
 * `app/[locale]/docs/[...slug]/page.tsx`
 *
 * This is the public light page for the docs route.
 *
 * Ownership reasoning:
 * - the route folder owns the full authored behavior surface
 * - both this page and generated heavy handlers delegate to
 *   `./route-contract`
 * - `withHeavyRouteFilter(...)` stays here because excluding heavy routes from
 *   the light catch-all is a page-entry concern
 */
...
/**
 * Enumerates all localized content slugs, then filters out any that are
 * already served by a dedicated heavy handler page. Without
 * `withHeavyRouteFilter`, Next.js would generate duplicate routes for the
 * heavy pages.
 */
