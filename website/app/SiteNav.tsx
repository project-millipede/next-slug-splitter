  ...
  return (
    <header className={styles.header}>
      <nav aria-label="Primary" className={styles.nav}>
        <Link aria-label="Home" className={styles.homeLink} href="/">
          <svg
            aria-hidden="true"
            className={styles.homeIcon}
            viewBox="0 0 24 24"
          >
            <rect width="24" height="24" rx="5.25" fill="#12676d" />
            <path
        ...
        <a
          ...
          href="https://github.com/project-millipede/next-slug-splitter"
          aria-label="GitHub"
          rel="noreferrer"
          target="_blank"
        >
