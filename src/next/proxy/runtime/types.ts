...
export type RouteHandlerProxyDecision =
  ...
  | {
       ...
       * rewrite response.
       *
       * 1. Pages Router lazy destinations stay locale-less during planning.
       * 2. Pages Router dev rewrites need the public locale as the first
       ...
       *    Router.
       * 5. Stable Pages build rewrites use the same destination transform
       *    during result construction and do not use this response metadata.
       *
       * @example
